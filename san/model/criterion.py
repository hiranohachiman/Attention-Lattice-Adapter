...
# Size of source mod 2**32: 11177 bytes
...
def cross_entropy_loss(inputs: torch.Tensor, targets: torch.Tensor):
    """
    Compute the cross entropy loss given inputs and targets.
    ...
    Returns:
    - loss (torch.Tensor): The cross entropy loss for the provided inputs and targets.
    """
...
class SetCriterion(nn.Module):
    __doc__ = 'This class computes the loss for DETR.\n    The process happens in two steps:\n        1) we compute hungarian assignment between ground truth boxes and the outputs of the model\n        2) we supervise each pair of matched ground-truth / prediction (supervise class and box)\n    '
