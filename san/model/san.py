...
from .visualize import (
    save_overlay_image_with_matplotlib,
    save_side_by_side_image,
...
class SAN(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        clip_resolution=0.5,
        pixel_mean=[0.48683309, 0.50015243, 0.43198669],
    ...
    def from_config(cls, cfg):
        ...
        for i in range(len(cfg.MODEL.SIDE_ADAPTER.DEEP_SUPERVISION_IDXS) - 1):
            ...
            caption_embedder = PredefinedOvClassifier(
                model,
                templates=get_predefined_templates(cfg.MODEL.SAN.CLIP_TEMPLATE_SET),
            )
    ...
    def forward(self, images):
        ...
        if self.with_mask:
            ...
            reshaped_mask_preds = torch.ones(
                (b, 1, H, W), dtype=mask_preds.dtype, device=mask_preds.device
            )
