...
class ConvReducer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = nn.Conv2d(in_channels=in_channels, out_channels=64, kernel_size=1, stride=1, padding=0)
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=out_channels, kernel_size=1, stride=1, padding=0)
