...
from ..layers import AttentionFusion
...
class RegionwiseSideAdapterNetwork(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        attn_fusions = nn.ModuleDict(
            {
                f"layer_{tgt_idx}": AttentionFusion(
                    input_shape[src_idx].channels, vit.num_features
                )
    ...
    def forward_features(
        ...
        # print("x.shape", x.shape) # [8, 1600, 240]
        # print("h, w", h, w) # 40, 40
