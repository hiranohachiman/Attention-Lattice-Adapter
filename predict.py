...
class Predictor(object):
    ...
    def _postprocess(self, result: torch.Tensor, ori_vocabulary: List[str]) -> np.ndarray:
        """
...
def pre_download():
    """pre download model from huggingface and open_clip to avoid network issue."""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab', type=str, default='', help='list of category name. separated with ,.')
    ...
    predictor.predict(args.img_path, args.vocab.split(','), args.aug_vocab, output_file=args.output_file)
